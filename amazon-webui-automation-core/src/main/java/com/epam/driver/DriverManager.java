...
public class DriverManager {
    ...
    private static final String NAME = Objects.requireNonNull(PropertyLoader.getValue("name"));
    private static final String PATH = Objects.requireNonNull(PropertyLoader.getValue("path"));
    private static final boolean HEADLESS_MODE = Boolean.parseBoolean(PropertyLoader.getValue("headless"));
